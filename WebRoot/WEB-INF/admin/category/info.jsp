...
<div class="content">
        ...
        <div class="container-fluid">
            ...
            <div class="span1"></div>
               ...
               <div class="span6">  	
					<h2>
					<span class="label"> 分 类 编 号: </span> 
					<span class="label label-success" >  ${category.id}</span>
					</h2>
					<h2>
					<span class="label"> 分 类 名 称 : </span>
					</h2>
						${category.name}	
					<h2>
					<span class="label"> 分 类  描 述: </span> 
					</h2>
					<p class="text-success">${category.descb}</p>		
               </div>
	...
	<script type="text/javascript">
		...
		function del(obj) {
			...
			var delurl = "Room_delete.action?category.id=" + delid
					+ "&pageNow=" + pNow;
			$("#myModal").modal("show").on("shown", function() {
				$("#delbtn2").attr('href', delurl);
			});
