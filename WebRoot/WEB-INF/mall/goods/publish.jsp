					...
					<div class="col-md-9">
						...
						<div class="account_grid">
							<form class="form-horizontal" method="post"
								action="<%=path%>/goods/publishNew.action"
								enctype="multipart/form-data" id="publishForm">
								<div class="form-group">
									<label class="col-sm-2 control-label">分 类</label>
									<div class="col-sm-10">
										<select  class="form-control" name="auditedgoods.category.id">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" placeholder="价 格"
											name="auditedgoods.price">
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-2 control-label">简 介</label>
									<div class="col-sm-10">
										<textarea name="auditedgoods.intro" cols="20" rows="2" class="form-control"></textarea>
								...
								<div class="form-group">
									<div class="col-sm-offset-2 col-sm-10">
										<button type="button" class="btn btn-primary" id="uploadBtn">上 传</button>
