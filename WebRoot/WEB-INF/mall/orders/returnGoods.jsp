					...
					<div class="col-md-9">
						...
						<div class="account_grid">
							...
							<input type="hidden" value="${orders.id }" name="orders.id">
								<textarea rows="" cols="" class="form-control" name="orders.memo"></textarea>
							</form>
							<BR/>
							<div class="form-actions">
						<c:if test="${orders.tradingSatuts eq '1'}">		<button type="button" class="btn btn-danger" onclick="returnGoods()">退货</button></c:if>
...
<script type="text/javascript">
	function returnGoods(){                                           //序列化表单值 
		$.post("<%=path%>/orders/returnGoods.action",$("#returnForm").serialize(),function(data){
